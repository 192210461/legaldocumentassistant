  ...
  return <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/upload-document" element={<ProtectedRoute>
                <UploadDocumentPage />
              </ProtectedRoute>} />
          ...
          <Route path="/agent-selection" element={<ProtectedRoute>
                <AgentSelectionPage />
              </ProtectedRoute>} />
          <Route path="/agents/clause-extraction" element={<ProtectedRoute>
                <ClauseExtractionPage />
              </ProtectedRoute>} />
          <Route path="/agents/risk-detection" element={<ProtectedRoute>
                <RiskDetectionPage />
              </ProtectedRoute>} />
          <Route path="/agents/drafting" element={<ProtectedRoute>
                <DraftingAgentPage />
              </ProtectedRoute>} />
          <Route path="/agents/summary" element={<ProtectedRoute>
                <SummaryAgentPage />
              </ProtectedRoute>} />
          <Route path="/reports" element={<ProtectedRoute>
                <ReportsPage />
              </ProtectedRoute>} />
          <Route path="/export-history" element={<ProtectedRoute>
                <ExportHistoryPage />
              </ProtectedRoute>} />
