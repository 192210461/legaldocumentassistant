  ...
  return <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden bg-deep-navy">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md z-10 relative">
        ...
        ease: 'easeOut'
          ...
          <motion.img src="/ChatGPT_Image_Nov_19%2C_2025%2C_09_28_42_AM.png" alt="DeepLex Logo" className="w-20 h-20 mx-auto mb-6 animate-float" animate={{
          filter: ['drop-shadow(0 0 20px rgba(0, 229, 255, 0.5))', 'drop-shadow(0 0 40px rgba(0, 229, 255, 0.8))', 'drop-shadow(0 0 20px rgba(0, 229, 255, 0.5))']
        }} transition={{
          duration: 2,
          repeat: Infinity
        }} />
